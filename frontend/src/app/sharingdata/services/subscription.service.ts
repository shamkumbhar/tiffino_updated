...
export class SubscriptionService {
  ...
  searchPlans(): Observable<any[]> {
    return this.http.get<any[]>(`${this.apiUrl}/subscription-plans/search-plan`);
  }
  ...
  pause(subscriptionId: number, token: string): Observable<any> {
    ...
    return this.http.put(`${this.apiUrl}/subscriptions/${subscriptionId}/pause`, {}, { headers });
  }
  ...
  cancel(subscriptionId: number, token: string) {
    ...
    return this.http.put(`${this.apiUrl}/subscriptions/${subscriptionId}/cancel`, {}, { headers });
  }
  ...
  deactivatesubscription(planId: any) {
    return this.http.put(`${this.apiUrl}/subscription-plans/deactivate/${planId}`, {}).subscribe({
      next: () => alert('subscription deactivated'),
      error: () => alert('subscription deactivation failed')
    });
  }
